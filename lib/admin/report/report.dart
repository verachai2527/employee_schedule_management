...
import 'package:employee_schedule_management/admin/employee/widget/profile.dart';
import 'package:employee_schedule_management/admin/report/widget/report_widget.dart';
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [
          /// Header Part
          HeaderWidget(headerName: "Report"),
          Expanded(
